...
addon_info = {
	...
	"addon_name": "data-ssml-handler",
	# Add-on summary/title, usually the user visible name of the add-on
	# Translators: Summary/title for this add-on
	# to be shown on installation and add-on information found in add-on store
	"addon_summary": _("data-ssml Handler for improved speech output"),
	# Add-on description
	# Translators: Long description to be shown for this add-on on add-on information from add-on store
	"addon_description": _("""An add-on that improves speech output by handling data-ssml attributes in HTML elements.
						This implements a proposals from the W3C Specification for Spoken Presentation in HTML"""),
	# version
	"addon_version": "0.1",
	# Author(s)
	...
	"addon_licenseURL": "https://choosealicense.com/licenses/mit/",
}
